import { LEARNING_COURSE_VISIBILITIES } from "../../../../lib/learning/coursesFoundation";
import { createLearningCourseAction } from "../../../learning/instructor/actions";
...
export default function CreateCourseForm({
  ...
  return (
    <form action={createLearningCourseAction} className="space-y-4">
      ...
      <label className="block">
        ...
        >
          {LEARNING_COURSE_VISIBILITIES.map((visibility) => (
