      ...
      <section className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
        ...
        >
          ...
          <input
            ...
            defaultValue=""
            aria-label={t("teacher.course.title")}
          />
          <textarea
            className="min-h-24 w-full rounded-2xl border border-white/10 bg-black/20 px-4 py-3"
            aria-label={t("teacher.course.description")}
          />
          <div className="grid gap-3 sm:grid-cols-2">
            <input
              className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3"
              placeholder={t("teacher.course.category")}
              aria-label={t("teacher.course.category")}
            />
            <input
              className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3"
              placeholder={t("teacher.course.level")}
              aria-label={t("teacher.course.level")}
            />
          </div>
          <button
            type="submit"
