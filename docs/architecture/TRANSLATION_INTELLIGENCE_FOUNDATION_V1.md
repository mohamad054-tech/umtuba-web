...
`20260875` created locally only — **not remote-applied**.
...
`20260875_translation_intelligence_foundation_v1.sql` adds
`translation_intelligence_*` tables only. Does not alter `20260874`.
