...
Implemented on `office/platform-private-ai-workflow-lifecycle-v1` (base
`db6f52a` Private AI Foundation). No training / fine-tuning / inference /
weights. Migration `20260880` created locally only — **not remote-applied**.
