...
Base tip: Collaboration Workspace Settings/Lifecycle UI V1 (`6ea0634`) with Smoke/E2E readiness ported from `616d4f7`
...
- Redesign of Settings/Lifecycle UI (this branch ports readiness onto the existing tip only)
