...
| # | Capability | Notes |
| --- | --- | --- |
| 1 | Live Payment Production Gate | closed (current SoT chain) |
| 2 | Transactional Notifications | closed |
| 3 | Seller Payout Rails | closed |
| 4 | Refund Operations Surface | closed |
| 5 | Digital Entitlement Revoke on Refund V1 | migration `20260889` |
...
| Item | Disposition |
| --- | --- |
| Historical commit `fded934` (`feat(commerce): activate default commission policies`) | **Obsolete / rejected** — not in current SoT tip `c9f9458`; do not merge or restore |
...
git rev-parse HEAD
# expect: tip of office/commerce-chain-migration-apply-readiness-v1-current (contains 89/90/91; base c9f9458)
