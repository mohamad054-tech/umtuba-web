...
2. ~~Trusted availability for catalog/cart/PDP~~ — `commerce.inventory.seller_inventory_availability_foundation_v1` (`SELLER_INVENTORY_AVAILABILITY_FOUNDATION_V1.md`)
