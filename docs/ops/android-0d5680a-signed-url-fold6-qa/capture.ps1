# Fold6 signed-URL regression QA capture helper. Do not write to Desktop.
$ErrorActionPreference = "Continue"
$Out = "C:\Users\1\Desktop\umtuba\worktrees\DESKTOP-ANDROID-0D5680A-SIGNED-URL-QA\docs\ops\android-0d5680a-signed-url-fold6-qa\evidence\qa"
$Serial = "RFCX718LVHK"
