...
const pages = [
  ["01-learning-home-desktop", "http://localhost:3017/learning?hl=en", 1440, 900, "en-US"],
  ["02-learning-home-mobile", "http://localhost:3017/learning?hl=en", 390, 844, "en-US"],
...
try {
  for (const [name, url, width, height, locale] of pages) {
    ...
    await page.waitForSelector(".learning-visual-root", { timeout: 20000 });
