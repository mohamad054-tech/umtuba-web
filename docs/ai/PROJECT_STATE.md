...
| Commerce Digital Entitlement Revoke on Refund V1 | **COMPLETE** (branch `office/commerce-digital-entitlement-revoke-on-refund-v1`) |
| Commerce Commission Decomposition Bridge Apply V1 | **COMPLETE** (branch `office/commerce-commission-decomposition-bridge-apply-v1`) |
| Commerce Commission Policy Activation V1 | **IMPLEMENTED locally** (branch `office/commerce-commission-policy-activation-v1`) — uncommitted; migration `20260891` not remote-applied |
