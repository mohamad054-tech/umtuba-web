...
| Commerce Partial Refund In-Flight Committing Visibility RPC Foundation V1 | **CORRECTIVE RENUMBER LOCAL** — branch `office/commerce-partial-refund-in-flight-committing-visibility-v1` @ `a3c155b` + uncommitted renumber to **`20260905`**; code closed; invalid `20260901` removed; Learning owns `20260901`; Translation owns `20260902–04`/`20260910`; live tip still **`20260900`**; orphan RPC may exist unregistered; await commit/apply GO for **`20260905` only** |

Default: Remote tip **`20260900`**. Commerce visibility local draft is **`20260905`** (not `20260901`/`20260903`). Learning owns `20260901`; Translation owns `20260902–04` and `20260910`. Orphan live `list_store_partial_refund_ledger_committing` may exist without history — rebind via `CREATE OR REPLACE` on apply GO + register **`20260905` only**. Live gate **OFF**. `commerce_confirm` false. Do not modify frozen Commerce architecture documents. Do not delete Store docs.
