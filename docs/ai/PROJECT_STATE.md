...
| Commerce Digital Entitlement Revoke on Refund V1 | **IMPLEMENTED locally** (branch `office/commerce-digital-entitlement-revoke-on-refund-v1-current`) — migration `20260889` not remote-applied |
