...
1. Worktree: `C:\Users\1\Desktop\umtuba\umtuba-web-shared-ai-surface-integration-v1`
...
- `.env.example` (model default docs)
- Handoff docs
...
- Home / Commerce / Learning UI churn unless required for existing AI wiring
