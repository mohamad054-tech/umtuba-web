...
/**
 * Ads Internal Delivery Pilot Foundation — inventory execution → pilotSuccess.
 *
 * Accepts ONLY a validated foundation AdsExecutionResult (post inventory →
 * eligibility → compatibility → selectable set → pilot selector → serve
 * boundary). Never accepts raw inventory or raw candidates.
 *
