 ...
 *
 * Chinese: Wave 2 lands Simplified as `zh-CN`. Traditional `zh-TW` is
 * reserved and must not collapse onto Simplified.
 */
 ...
 * Examples: ar-PS → ar, en-US → en, fr_CA → fr, zh-Hans → zh-CN.
