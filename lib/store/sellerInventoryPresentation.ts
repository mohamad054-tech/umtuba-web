 ...
 * Uses trusted availableUnits. Does not invent allocated/damaged/quarantine.
 */
 ...
 * Adjustment intents and movement-ledger contracts are separate foundations and are not applied here.
 */
export function productEditorInventoryAlignmentCopy(): {
  ...
  return {
    ...
    body: "On-hand and safety stock edits here run through the trusted draft/in-review catalog upsert. They are not warehouse movements or adjustment ledger entries. Adjustment intents and movement ledger contracts remain contract-only until apply/record runtimes exist. Canonical visibility and reservation pressure live in Inventory.",
    reservedNote:
