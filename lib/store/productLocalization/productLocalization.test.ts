...
describe("store locale money and UM Points on the QA sample", () => {
  it("uses EN $49.99 and AR 49.99 US$ plus the Arabic UM Points sentence", () => {
    ...
    const arMessages = readFileSync(join(process.cwd(), "lib/i18n/messages/ar.ts"), "utf8");
    expect(arMessages).toMatch(/احصل على \{count\} نقطة أم طوبا عند شراء هذا المنتج/);
