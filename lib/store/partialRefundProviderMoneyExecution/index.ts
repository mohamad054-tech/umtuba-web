...
export {
  ...
  type StripeTestDependencyChainCapabilityFlags,
  type StripeTestDependencyChainCapabilityKey,
  type StripeTestDependencyChainIntegrationProofInput,
  type StripeTestDependencyChainIntegrationProofReport,
  type StripeTestDependencyChainIntegrationProofVerdict,
  type StripeTestDependencyChainMissingDep,
  type StripeTestDependencyChainNextPrecheckBoundary,
  type StripeTestDependencyChainSotIntegration,
  type StripeTestDependencyChainWorkspacePresence,
