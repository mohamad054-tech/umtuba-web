-- UMTUBA World catalog ingest — OVERVIEW enrich (all catalog cities)
...
from (
  values
  ('jerusalem', 'Jerusalem is a historic city in Palestine, in the Judean Mountains between the Mediterranean Sea and the Dead Sea.'),
  ('amman', 'Amman is the capital of Jordan, on the East Bank plateau east of the Jordan River.'),
  ('istanbul', 'Istanbul is Türkiye’s largest city, spanning the Bosporus between Europe and Asia.'),
  ('berlin', 'Berlin is the capital of Germany, in the northeast of the country on the rivers Spree and Havel.'),
  ('dubai', 'Dubai is a major city in the United Arab Emirates, on the southern coast of the Persian Gulf.'),
  ('new-york', 'New York is a major city in the United States, at the mouth of the Hudson River on the Atlantic coast.'),
  ('tokyo', 'Tokyo is the capital of Japan, on the eastern coast of Honshu around Tokyo Bay.'),
  ('cairo', 'Cairo is the capital of Egypt, on the Nile near the Giza plateau and historic Islamic Cairo.'),
