-- UMTUBA Push Tokens Foundation V1 - REISSUE
-- Reissued from 20260805_push_tokens_foundation_v1.sql for forward-only apply after remote tip.
-- Do NOT replay 20260805 behind tip. Version 20260927 is authoritative for production apply.
