...
-- It does not generate archives, email download links, or read user content.
-- Operator/Central fulfillment of queued requests is a later controlled step.
--
-- Do NOT apply to the remote Supabase project from this task.
...
comment on table public.data_export_requests is
  'Authenticated data-export requests from the public web flow. Queued for operator fulfillment; does not generate archives by itself.';
